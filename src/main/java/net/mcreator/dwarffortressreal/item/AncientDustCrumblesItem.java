...
public class AncientDustCrumblesItem extends Item {
	public AncientDustCrumblesItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("These could probably make ancient dust with use of a compressor."));
	}
}
