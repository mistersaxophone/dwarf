...
public class AncientScrapItem extends Item {
	public AncientScrapItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("You could probably use a refinery to make netherite scrap out of this."));
	}
}
