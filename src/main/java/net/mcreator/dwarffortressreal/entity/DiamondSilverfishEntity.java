...
public class DiamondSilverfishEntity extends Monster {
	public DiamondSilverfishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DwarfFortressRealModEntities.DIAMOND_SILVERFISH.get(), world);
	}

	public DiamondSilverfishEntity(EntityType<DiamondSilverfishEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(DwarfFortressRealModItems.DIAMOND_DUST.get()));
	}
