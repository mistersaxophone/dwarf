...
public class CoalSilverfishEntity extends Monster {
	public CoalSilverfishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DwarfFortressRealModEntities.COAL_SILVERFISH.get(), world);
	}

	public CoalSilverfishEntity(EntityType<CoalSilverfishEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(DwarfFortressRealModItems.COAL_DUST.get()));
	}
