...
public class CopperSilverfishEntity extends Monster {
	public CopperSilverfishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DwarfFortressRealModEntities.COPPER_SILVERFISH.get(), world);
	}

	public CopperSilverfishEntity(EntityType<CopperSilverfishEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(DwarfFortressRealModItems.COPPER_DUST.get()));
	}
