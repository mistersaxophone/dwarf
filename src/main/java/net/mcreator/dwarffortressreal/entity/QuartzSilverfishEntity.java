...
public class QuartzSilverfishEntity extends Monster {
	public QuartzSilverfishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DwarfFortressRealModEntities.QUARTZ_SILVERFISH.get(), world);
	}

	public QuartzSilverfishEntity(EntityType<QuartzSilverfishEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(DwarfFortressRealModItems.QUARTZ_DUST.get()));
	}
