...
public class GoldSilverfishEntity extends Monster {
	public GoldSilverfishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DwarfFortressRealModEntities.GOLD_SILVERFISH.get(), world);
	}

	public GoldSilverfishEntity(EntityType<GoldSilverfishEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(DwarfFortressRealModItems.GOLD_DUST.get()));
	}
